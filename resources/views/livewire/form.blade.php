    ...
    <form id="registrationForm">
        ...
        <div class="mb-3">
            <div class="form-check">
                <input type="radio" id="internet" name="sumber_informasi" value="Internet" class="form-check-input"
                    required />
                <label for="internet" class="form-check-label">Internet/Website</label>
            </div>
            <div class="form-check">
                <input type="radio" id="brosur" name="sumber_informasi" value="Brosur" class="form-check-input"
                    required />
                <label for="brosur" class="form-check-label">Brosur</label>
            </div>
            <div class="form-check">
                <input type="radio" id="spanduk" name="sumber_informasi" value="Spanduk" class="form-check-input"
                    required />
                <label for="spanduk" class="form-check-label">Spanduk</label>
            </div>
            <div class="form-check">
                <input type="radio" id="media_cetak" name="sumber_informasi" value="Media_cetak"
                    class="form-check-input" required />
                <label for="media_cetak" class="form-check-label">Media Cetak (Koran, Majalah)</label>
            </div>
            <div class="form-check">
                <input type="radio" id="teman" name="sumber_informasi" value="Teman"
                    class="form-check-input" required />
                <label for="teman" class="form-check-label">Teman</label>
            </div>
            <div class="form-check">
                <input type="radio" id="keluarga" name="sumber_informasi" value="Keluarga"
                    class="form-check-input" required />
